...
func init() {
	locpool.Resources["en"] = map[string]string{
		...
		"promoDisabled":       "Promo code has already been activated, so it was disabled instead of deleted",
	...
	locpool.Resources["ru"] = map[string]string{
		...
		"promoDisabled":       "Промокод уже был активирован, поэтому он отключен вместо удаления",
